  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div>
        ...
        <p className="text-white/40 text-sm mt-1">Manage your administrator profile and platform preferences.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center">
            <div className="w-20 h-20 rounded-full bg-[#F59F01]/20 flex items-center justify-center mx-auto mb-4 border border-[#F59F01]/30">
              <Settings size={32} className="text-[#F59F01]" />
            </div>
            <h3 className="text-white font-bold">{user?.first_name} {user?.last_name}</h3>
            <p className="text-white/30 text-[10px] uppercase tracking-widest mt-1 font-bold">General Partner Admin</p>
            
            <div className="mt-6 pt-6 border-t border-white/5 space-y-4 text-left">
              <div className="flex items-center justify-between text-xs">
                <span className="text-white/30">User ID</span>
                <span className="text-white/40 font-mono">{user?.id?.substring(0, 8)}...</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-white/30">Role</span>
                <span className="text-[#F59F01] font-bold uppercase tracking-tighter">Admin</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <h4 className="text-white font-bold text-xs uppercase tracking-widest mb-4 flex items-center gap-2">
              <Users size={14} className="text-[#F59F01]" /> Team Access
            </h4>
            <p className="text-[10px] text-white/40 leading-relaxed">
              You have administrative access to the Fund Management and Deal Flow modules.
            </p>
          </div>
        </div>
          ...
          <form className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
            <div className="p-6 border-b border-white/10 bg-white/[0.01]">
              <h3 className="text-sm font-bold text-white flex items-center gap-2 uppercase tracking-widest">
                <User size={16} className="text-[#F59F01]" /> Administrator Info
              </h3>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-[#0a0014] border border-white/10 rounded-xl py-3 px-4 text-white text-sm focus:border-[#F59F01] outline-none transition-all"
                  />
                </div>
                <div className="space-y-2">
            ...
            <div className="p-6 bg-white/[0.02] border-t border-white/10 flex justify-end">
              <button 
                type="button"
                className="bg-[#F59F01] hover:bg-[#F59F01]/80 text-black font-bold px-6 py-2.5 rounded-xl flex items-center gap-2 transition-all"
              >
                <Save size={16} />
                Save Profile
              </button>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/40 uppercase tracking-widest mt-0.5">Recommended for admins</p>
              </div>
            </div>

...
const steps = [
  ...
  },
  {
    id: "02",
    title: "Screening",
    description: "Our AI-powered engine evaluates your submission across financial, commercial, and operational criteria.",
    icon: <ClipboardCheck className="w-6 h-6" />,
  },
  {
    id: "03",
    title: "IC Review",
    description: "If selected, our Investment Committee conducts a deep valuation and prepares a formal investment memo.",
    icon: <Search className="w-6 h-6" />,
  },
  {
    id: "04",
    title: "Term Sheet & LOI",
    description: "We present our terms. You review, negotiate, and sign the Letter of Intent.",
    icon: <Handshake className="w-6 h-6" />,
  },
  {
    id: "05",
    title: "Partnership",
    description: "Capital is called, contracts are signed, and we begin our journey together.",
    icon: <Handshake className="w-6 h-6" />,
  },
];

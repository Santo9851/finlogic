...
>>>>>>> 5b3f52a768598bcc3e5a89f835fcbb912e3e2468
        ...
        <div className="flex gap-3 shrink-0 self-end sm:self-start">
          {!task.isMandatory && (
            <button
              onClick={() => toggleStatus('NOT_NEEDED')}
              className={`px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-lg ${status === 'NOT_NEEDED' ? 'bg-foreground text-background' : 'bg-foreground/5 text-text-muted/40 hover:text-foreground'
                }`}
            >
              Exempt
            </button>
          ...
          <button
            onClick={() => toggleStatus('FULFILLED')}
            className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all shadow-2xl ${status === 'FULFILLED' ? 'bg-emerald-500 text-white' : 'bg-foreground/5 text-text-muted/20 hover:text-emerald-500 hover:bg-emerald-500/10'
              }`}
          >
            <Check size={24} strokeWidth={4} />
          </button>
  ...
  return (
    <div className="flex items-center justify-between group py-2">
      ...
      <button
        ...
        className={`px-6 py-2.5 border rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all shadow-lg active:scale-95 ${isCleared
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              {isCleared ? (
                ...
                <button
                  ...
                  className={`flex-1 py-6 rounded-[1.5rem] text-[10px] font-black uppercase tracking-[0.3em] shadow-[0_32px_64px_-16px_rgba(245,159,1,0.2)] transition-all active:scale-95 ${isAllTasksDone
